...
- **Notebook `%pip` install of the wheel** — ALWAYS `@ file:///Volumes/…/geobrix-<ver>-py3-none-any.whl` **with the extra** (`light_dbr19` on dogfood incl. its serverless env v6; `light` on e2/oauth-fe serverless env v5 / classic DBR ≤18):
