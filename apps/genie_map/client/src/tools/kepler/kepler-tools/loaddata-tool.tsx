...
function isLoadDataContext(context: unknown): context is LoadDataToolContext {
  return context !== null && typeof context === 'object' && typeof (context as LoadDataToolContext).getLoaders === 'function';
}

// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function executeLoadData({url}: {url: string}, options: any): Promise<ExecuteLoadDataResult> {
  try {
...
export function LoadDataToolComponent({parsedData}: {parsedData: ProtoDataset[]}) {
