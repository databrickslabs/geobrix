...
import pmtilesLightCode from '!!raw-loader!../../tests/python/api/pmtiles_functions_python_light.py';
...
<FunctionExamples
  name="pmtiles_agg"
  sql={pmtilesSqlCode}           sqlSource="docs/tests/python/api/pmtiles_functions_sql.py"
  pythonLight={pmtilesLightCode} pythonLightSource="docs/tests/python/api/pmtiles_functions_python_light.py"
  ...
  testFile="docs/tests/python/api/test_pmtiles_functions_python_light.py"
/>
