...
Four functions for building raster products from LiDAR point clouds. Available on the
**lightweight tier only** (`pyrx`). Load point clouds with the [`lidar_gbx` reader](../readers/lidar).
