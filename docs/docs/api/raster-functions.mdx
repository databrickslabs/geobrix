...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_crs_sql_example" outputConstant="rst_crs_sql_example_output" code={rasterxSqlCode} />
...
`gbx_rst_quadbin_rasterize_agg` returns a tile **`STRUCT<cellid, raster, metadata>`**.

**Signature:** `rst_quadbin_rasterize_agg(geom: Column, value: Column, xmin: Column, ymin: Column, xmax: Column, ymax: Column, width: Column, height: Column, srid: Column): Column`
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_quadbin_rasterize_agg_sql_example" outputConstant="rst_quadbin_rasterize_agg_sql_example_output" code={rasterxSqlCode} />
...
`gbx_rst_bng_rasterize_agg` returns a tile **`STRUCT<cellid, raster, metadata>`**.

**Signature:** `rst_bng_rasterize_agg(geom: Column, value: Column, xmin: Column, ymin: Column, xmax: Column, ymax: Column, width: Column, height: Column, srid: Column): Column`
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rasterize_agg_sql_example" outputConstant="rst_bng_rasterize_agg_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_quadbin_tessellate_sql_example" outputConstant="rst_quadbin_tessellate_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_tessellate_sql_example" outputConstant="rst_bng_tessellate_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_h3_rastertogridsum_sql_example" outputConstant="rst_h3_rastertogridsum_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_h3_rastertogridvariance_sql_example" outputConstant="rst_h3_rastertogridvariance_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_h3_rastertogridstddev_sql_example" outputConstant="rst_h3_rastertogridstddev_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_quadbin_rastertogridsum_sql_example" outputConstant="rst_quadbin_rastertogridsum_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_quadbin_rastertogridvariance_sql_example" outputConstant="rst_quadbin_rastertogridvariance_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_quadbin_rastertogridstddev_sql_example" outputConstant="rst_quadbin_rastertogridstddev_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridavg_sql_example" outputConstant="rst_bng_rastertogridavg_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridcount_sql_example" outputConstant="rst_bng_rastertogridcount_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridmax_sql_example" outputConstant="rst_bng_rastertogridmax_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridmin_sql_example" outputConstant="rst_bng_rastertogridmin_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridmedian_sql_example" outputConstant="rst_bng_rastertogridmedian_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridsum_sql_example" outputConstant="rst_bng_rastertogridsum_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridvariance_sql_example" outputConstant="rst_bng_rastertogridvariance_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_bng_rastertogridstddev_sql_example" outputConstant="rst_bng_rastertogridstddev_sql_example_output" code={rasterxSqlCode} />
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_transformcrs_sql_example" outputConstant="rst_transformcrs_sql_example_output" code={rasterxSqlCode} />
...
The lightweight Python binding also accepts **`xscale` and `yscale`** in place of the single `scale`, applying them per axis (`sqrt((dz/dx / xscale)² + (dz/dy / yscale)²)`). GDAL's `gdaldem -s` is one ratio for both axes, so anisotropic scaling has no heavyweight equivalent; pass both `xscale` and `yscale` or neither. Defaults match across tiers — when no scale is supplied, both derive the horizontal scale from the raster CRS — so only explicit-scale calls differ.
:::

**Signature:** `rst_slope(tile: Column, unit: Column, scale: Column): Column` — Compute slope per pixel. `unit` is `'degrees'` or `'percent'`; `scale` is the elevation/horizontal unit ratio (use `111120` for unprojected lon/lat in degrees). Lightweight Python additionally offers `xscale`/`yscale` (see the note above).
...
<CodeFromTest language="sql" source="docs/tests/python/api/rasterx_functions_sql.py" testFile="docs/tests/python/api/test_rasterx_functions_sql.py" functionName="rst_setcrs_sql_example" outputConstant="rst_setcrs_sql_example_output" code={rasterxSqlCode} />
