...
**Function Count**: 65 functions organized into 6 categories (see [rasterx/functions.scala](https://github.com/databrickslabs/geobrix/blob/master/src/main/scala/com/databricks/labs/gbx/rasterx/functions.scala)):
