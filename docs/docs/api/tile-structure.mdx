...
![GeoBrix tile schema — cellid (bigint, nullable), raster (binary, nullable), path/window/clip_polygon/clip_crs/crs provenance fields, metadata (map of string to string), path_mode (string, storage mode: null / 'external' / 'managed')](../../../resources/images/diagrams/rasterx/rasterx-tile-structure.png)
