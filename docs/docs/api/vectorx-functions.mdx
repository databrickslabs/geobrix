...
These three functions are distributed shapely helpers — shapely/GEOS geometry operations running as Python UDFs across your Spark cluster. They are **lightweight tier only** (`pyvx`); no heavyweight counterpart exists. See [Geometry Validity & Antimeridian](./geometry-validity-antimeridian) for the full composition pattern.
...
See [Geometry Validity & Antimeridian](./geometry-validity-antimeridian).
...
- [Geometry Validity & Antimeridian](./geometry-validity-antimeridian) — antimeridian composition pattern with full example
