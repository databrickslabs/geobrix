...
The committed fixtures backing these views live under [`src/test/resources/binary/elevation/`](https://github.com/databrickslabs/geobrix/tree/main/src/test/resources/binary/elevation) (inline WKB) and as inline WKB in the fixture helpers (MVT, CRS, legacy geometry).
