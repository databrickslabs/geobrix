...
E 0–700 km, N 0–1300 km). A source outside this envelope produces no meaningful
cells — its reprojected coverage is empty, so every candidate tile is all-nodata
and pruned.
