...
example, *"which operators have wells near the strongest plumes?"* When the answer carries
a geometry, Genie Map draws it as a map layer next to the others, so a spoken question and
a drawn map answer share one canvas.
