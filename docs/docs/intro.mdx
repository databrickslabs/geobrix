...
<div style={{
  ...
  <div style={{
    ...
    <div style={{fontSize: '2.75rem', fontWeight: 800, lineHeight: 1, color: '#2e7d32'}}>232</div>
...
GridX's 60 functions break down as **BNG (24)**, **Quadbin (16)**, **custom grids (14)**, and **H3 (6)**.
