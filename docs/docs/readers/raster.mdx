...
The planning overhead grows linearly with file count; at 10K+ files a manifest or tile table is the most effective remedy. See [Benchmarking → Reader plan-time listing](../api/benchmarking#reader-plan-time-listing) for the methodology.
:::
