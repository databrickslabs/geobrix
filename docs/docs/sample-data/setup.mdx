...
**[setup_sample_data.ipynb](https://github.com/databrickslabs/geobrix/blob/main/notebooks/sample-data/setup_sample_data.ipynb)** — download and import into your Databricks workspace to run the setup.
:::
...
| Essential | SRTM NYC | `nyc/elevation/srtm_n40w074.hgt` | 24.7 MB | **SRTM HGT** — elevation DEM; slope, aspect, hillshade. Driver: SRTMHGT |
...
| Essential | SRTM London | `london/elevation/srtm_n51w001.hgt` | 24.7 MB | **SRTM HGT** — elevation DEM; terrain analysis. Driver: SRTMHGT |
...
| Complete | SRTM NYC East | `nyc/elevation/srtm_n40w073.hgt` | 24.7 MB | **SRTM HGT** — elevation DEM; extended terrain. Driver: SRTMHGT |
