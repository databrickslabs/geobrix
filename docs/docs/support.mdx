...
2. **Review Documentation**: Check this documentation and the [README](https://github.com/databrickslabs/geobrix/blob/master/README.md)
...
See [CONTRIBUTING.md](https://github.com/databrickslabs/geobrix/blob/master/CONTRIBUTING.md) for more details.
...
GeoBrix is provided under the license specified in the [LICENSE](https://github.com/databrickslabs/geobrix/blob/master/LICENSE) file.
