...
USAGE:
    bash scripts/commands/gbx-docs-start.sh [OPTIONS]
...
EXAMPLES:
    ...
    bash scripts/commands/gbx-docs-start.sh

    # Serve without rebuild
    bash scripts/commands/gbx-docs-start.sh --skip-build

    # Use custom port
    bash scripts/commands/gbx-docs-start.sh --port 3001

    # Build and log output
    bash scripts/commands/gbx-docs-start.sh --log docs-server.log
