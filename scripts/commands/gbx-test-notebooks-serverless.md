...
- `--extras CSV` – Geobrix extras whose deps to install (default: `light_env6,stac,vizx,overture`).
...
(`notebooks/examples/helios/0*.ipynb`) with `extras=light_env6,stac,vizx,overture`
and `--extra-deps rich`.
