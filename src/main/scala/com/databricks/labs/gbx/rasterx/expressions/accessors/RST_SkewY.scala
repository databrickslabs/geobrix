...
case class RST_SkewY(
    ...
    override def prettyName: String = RST_SkewY.name
    override def replacement: Expression = rstInvoke(RST_SkewY, rasterType)
...
object RST_SkewY extends WithExpressionInfo {
    ...
    def execute(ds: Dataset): Double = {
        ...
        // y_scale is the fifth element in the GeoTransform array
        gt(4)
    }

    override def name: String = "gbx_rst_skewy"

    override def builder(): FunctionBuilder = (c: Seq[Expression]) => new RST_SkewY(c(0))
