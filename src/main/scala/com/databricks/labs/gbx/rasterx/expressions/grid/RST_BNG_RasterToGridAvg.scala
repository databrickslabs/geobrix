...
case class RST_BNG_RasterToGridAvg(tile: Expression, resolution: Expression) extends InvokedExpression {
    ...
    override def replacement: Expression = invoke(RST_BNG_RasterToGridAvg)
