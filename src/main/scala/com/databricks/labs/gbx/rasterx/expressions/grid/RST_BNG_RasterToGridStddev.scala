...
case class RST_BNG_RasterToGridStddev(tileExpr: Expression, resolution: Expression) extends InvokedExpression {
    ...
    override def replacement: Expression = rstInvoke(RST_BNG_RasterToGridStddev, rasterType)
