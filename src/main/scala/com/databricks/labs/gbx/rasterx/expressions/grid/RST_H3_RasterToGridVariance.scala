...
case class RST_H3_RasterToGridVariance(
    ...
    override def replacement: Expression = rstInvoke(RST_H3_RasterToGridVariance, rasterType)
...
object RST_H3_RasterToGridVariance extends WithExpressionInfo {
    ...
    def execute(ds: Dataset, resolution: Int): Array[Array[(Long, Double)]] = {
        ...
        RST_H3_RasterToGrid.execute(ds, resolution, varF)
    }

    override def name: String = "gbx_rst_h3_rastertogridvariance"

    override def builder(): FunctionBuilder = (c: Seq[Expression]) => new RST_H3_RasterToGridVariance(c(0), c(1))
